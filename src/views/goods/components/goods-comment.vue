<template>
  <div class="goods-comment">
    ...
    <div class="head" v-if="commentInfo">
      ...
      <!-- 分页 -->
    <XtxPagination v-if="total>0" @current-change="changePager" :total="total" :current-page="reqParams.page"  />
  </div>
</template>
<script>
...
export default {
  ...
  setup (props) {
    ...
    // 同步子组件current page， watch（reqParams）重新发送请求
    ...
    return { commentInfo, changeTag, reqParams, commentList, changeSort, formatSpecs, formatNickname, currTagIndex, changePager, total }
  }
}
</script>
