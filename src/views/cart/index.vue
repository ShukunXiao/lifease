    ...
    <div class="container">
      ...
      <div class="cart">
        <table>
          <thead>
            <tr>
              <th width="120"><XtxCheckbox @update:modelValue="checkAll" :modelValue="$store.getters['cart/isCheckAll']">全选</XtxCheckbox></th>
          ...
          <tbody>
            ...
            <td><XtxCheckbox @update:modelValue="($event)=> checkOne(item.skuId, $event)" :modelValue="item.selected" /></td>
              <td>
                <div class="goods">
                  ...
                  <div>
                    ...
                    <!-- 选择规格组件 -->
                    <CartSku @change="updateCartSku(item.skuId,$event)" :attrs-text="item.attrsText" :skuId="item.skuId">
                      <template v-slot:324 ><div>123</div>div></template>
                    </CartSku>
                  </div>
                </div>
              </td>
              ...
              <td class="tc">
                <XtxNumbox :max="item.stock" @update:goodnum="$event=>changeCount(item.skuId,$event)" :goodnum="item.count" />
              </td>
              ...
              <td>
                <div class="goods">
                  ...
                  <div>
                    ...
                    <p class="attr">颜色：粉色 尺: 14cm 产地：中国</p>
                  </div>
                </div>
              </td>
      ...
      <div class="action">
        <div class="batch">
          <XtxCheckbox @update:modelValue="checkAll" :modelValue="$store.getters['cart/isCheckAll']">全选</XtxCheckbox>
